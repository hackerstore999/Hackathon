...
int pirSensorPin = 5;     // Digital pin to which the PIR motion sensor is connected (change as needed, GPIO 5 in this case)
int ledPin = 4;           // Digital pin to which the LED is connected (change as needed, GPIO 4 in this case)
